 ...
 {
    // QZipReader zip("D:\word.zip");
    // zip.extractAll("D:\directory");

     QString fn = QFileDialog::getOpenFileName(this, tr("Open File..."),
                                               QString(), tr("All Files (*)"));

     QDir tempdir;
     tempdir.setPath("E:\111");
     QString program = "7z a - tzip E:\word.zip ./ E:\111 /*";
     QProcess *zipProcess  = new QProcess();
     zipProcess->start(program);
    /*QFile zipfile;
    zipfile.setFileName(fn);
    QString program = "7z - y x./" + fn;
    QProcess *zipProcess  = new QProcess();
    zipProcess->start(program);
